  ...
  return (
    <>
      ...
      <div class="flex flex-col justify-center items-center pt-4">
        <div class="relative flex flex-col items-center rounded-[10px] border-[1px] border-gray-200 lg:w-[40%] md:w-[70%] sm:w-[90%] xs:w-[90%] mx-auto p-4 bg-white bg-clip-border shadow-md shadow-[#F3F3F3] dark:border-[#ffffff33] dark:!bg-navy-800 dark:text-white dark:shadow-none">
            ...
            >
              <div class="flex items-center gap-3">
                ...
                <div class="flex flex-col">
                  <h5 class="text-base font-bold text-navy-700 dark:text-white uppercase">
                    {item.city}
                  </h5>
